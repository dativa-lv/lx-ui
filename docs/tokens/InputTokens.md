...
|-------------------------------------|-----------------------------------------------------------------------------------------|
| `--input-border-width`              | var(--border-width-2) var(--border-width-2) var(--border-width-1) var(--border-width-2) |
...
| Variable name                              | Default value                                                        |
|--------------------------------------------|----------------------------------------------------------------------|
| `--color-input-border`                     | transparent transparent var(--color-label) transparent               |
| `--color-input-border-disabled`            | transparent transparent var(--color-disabled-foreground) transparent |
...
| `--color-input-border`                        | `--contrast-foreground`                                |
| `--color-input-border-disabled`               | `--contrast-foreground`                                |
