...
| `--button-padding`               | `--space-0` calc(`--space-1000` - `--button-border-width`)    |
| `--button-width`                 | auto                                                          |
...
| `--button-primary-border`                  | `--button-primary-border-width` solid `--color-interactive-background`             |
...
| `--button-secondary-border`                | `--button-secondary-border-width` solid `--color-interactive-secondary-background` |
...
| `--button-tertiary-border`                 | `--button-tertiary-border-width` solid `--color-interactive-background`            |
