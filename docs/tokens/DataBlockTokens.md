...
| `--data-block-content-padding-m`            | `--space-1000`                                                 |
| `--data-block-content-padding-l`            | `--space-2000`                                                 |
...
| `--data-block-left-indent-m`                | `--space-1000`                                                 |
| `--data-block-left-indent-l`                | `--space-2000`                                                 |
| `--data-block-right-indent-m`               | `--space-1000`                                                 |
| `--data-block-right-indent-l`               | `--space-2000`                                                 |
...
| `--data-block-text-primary-padding`         | var(--space-0250) var(--space-0)                               |
...
| `--data-block-text-secondary-padding`       | var(--space-0) var(--space-0) var(--space-0250) var(--space-0) |
...
| `--color-data-block-button-icon`         | `--color-data`                    |
